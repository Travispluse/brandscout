    ...
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-neutral max-w-none space-y-6 text-sm leading-relaxed">
        <section>
          ...
          <p className="text-gray-500">BrandScout is committed to providing accurate, up-to-date, and useful information about brand naming, domain availability, and digital identity. Our content is researched, written, and reviewed to ensure it meets high standards of quality and reliability.</p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-500">Our data comes from publicly available sources including DNS lookups, RDAP/WHOIS databases, and platform-specific APIs. Blog content references industry publications, official documentation, and expert knowledge. We cite sources where applicable.</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-3">AI Disclosure</h2>
          <p className="text-gray-500">Some content on BrandScout may be created or assisted by artificial intelligence tools. All AI-generated content is reviewed by the BrandScout team for accuracy, relevance, and quality before publication. AI-assisted content is held to the same editorial standards as human-written content.</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-3">Corrections Policy</h2>
          <p className="text-gray-500">We take errors seriously. If you find inaccurate information on BrandScout:</p>
          <ul className="list-disc pl-5 space-y-2 text-gray-500">
        ...
        <section>
          ...
          <p className="text-gray-500">BrandScout may contain links to domain registrars or related services. Any commercial relationships are disclosed. Our tool results and editorial content are never influenced by commercial partnerships.</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-3">Independence</h2>
          <p className="text-gray-500">Our editorial decisions are made independently. No external party has influence over our content, tool functionality, or recommendations. We serve our users first.</p>
        </section>

        <p className="text-gray-500 text-xs mt-8">Last updated: February 2026</p>
      </div>
    </div>
  );
}
